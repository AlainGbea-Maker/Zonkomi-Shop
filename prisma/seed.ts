...
const products = [
  ...
  { name: 'Google Pixel 7 Pro', slug: 'google-pixel-7-pro', categoryId: 'Smartphones', price: 549.99, originalPrice: 999.99, condition: 'Like New', brand: 'Google', featured: false, stock: 15, rating: 4.5, reviewCount: 29, shortDesc: '6.7" LTPO OLED, Tensor G2, 128GB', description: 'The Pixel 7 Pro delivers Google\'s best AI-powered camera in a stunning design. With the Tensor G2 chip, you get smart features and excellent performance.', images: '["📱"]', specs: '{"Display": "6.7\" LTPO OLED", "Chip": "Google Tensor G2", "Storage": "128GB", "Camera": "50MP + 48MP + 12MP", "Battery": "5000mAh"}' },
  ...
  { name: 'Bose QuietComfort 45', slug: 'bose-quietcomfort-45', categoryId: 'Headphones', price: 199.99, originalPrice: 329.99, condition: 'Good', brand: 'Bose', featured: false, stock: 12, rating: 4.4, reviewCount: 47, shortDesc: 'Iconic noise cancelling, legendary comfort', description: 'Bose QuietComfort 45 headphones combine world-class noise cancellation with legendary Bose comfort. Premium sound quality for music and calls.', images: '["🎧"]', specs: '{"Driver": "Proprietary", "Noise Cancelling": "Yes (Aware/Quiet modes)", "Battery": "Up to 24 hours", "Bluetooth": "5.1", "Weight": "240g"}' },

  // Monitors
  { name: 'LG UltraFine 27" 4K', slug: 'lg-ultrafine-27-4k', categoryId: 'Monitors', price: 399.99, originalPrice: 699.99, condition: 'Excellent', brand: 'LG', featured: true, stock: 5, rating: 4.5, reviewCount: 22, shortDesc: '27" 4K UHD, IPS, USB-C, HDR400', description: 'A stunning 27-inch 4K UHD monitor with IPS technology, USB-C connectivity, and HDR400 support. Perfect for creative professionals.', images: '["🖥️"]', specs: '{"Display": "27\" 4K UHD (3840x2160)", "Panel": "IPS", "HDR": "HDR400", "Ports": "USB-C, HDMI, DisplayPort", "Response Time": "5ms"}' },
  { name: 'Dell UltraSharp U2722D', slug: 'dell-ultrasharp-u2722d', categoryId: 'Monitors', price: 349.99, originalPrice: 619.99, condition: 'Good', brand: 'Dell', featured: false, stock: 8, rating: 4.3, reviewCount: 15, shortDesc: '27" QHD, IPS, USB-C Hub, 98% DCI-P3', description: 'The Dell UltraSharp U2722D delivers exceptional color accuracy with 98% DCI-P3 coverage, USB-C hub, and a comfortable viewing experience.', images: '["🖥️"]', specs: '{"Display": "27\" QHD (2560x1440)", "Panel": "IPS", "Color": "98% DCI-P3", "Ports": "USB-C (90W), HDMI, DP", "Response Time": "5ms"}' },

  // Desktops
  { name: 'HP ProDesk 400 G7 Desktop', slug: 'hp-prodesk-400-g7', categoryId: 'Desktops', price: 399.99, originalPrice: 749.99, condition: 'Good', brand: 'HP', featured: false, stock: 4, rating: 4.1, reviewCount: 12, shortDesc: 'Intel i5-10500, 8GB RAM, 256GB SSD', description: 'A reliable desktop PC for business and everyday use. Features an Intel i5 processor, ample RAM, and fast SSD storage.', images: '["🖥️"]', specs: '{"Processor": "Intel i5-10500", "RAM": "8GB DDR4", "Storage": "256GB SSD", "Graphics": "Intel UHD 630", "Form Factor": "Desktop Tower"}' },
  { name: 'Apple Mac Mini M1', slug: 'apple-mac-mini-m1', categoryId: 'Desktops', price: 549.99, originalPrice: 999.99, condition: 'Like New', brand: 'Apple', featured: true, stock: 6, rating: 4.7, reviewCount: 34, shortDesc: 'M1 chip, 8GB RAM, 256GB SSD', description: 'The incredibly compact Mac Mini with M1 chip delivers desktop-class performance. Perfect as a home office workstation or media server.', images: '["🖥️"]', specs: '{"Processor": "Apple M1", "RAM": "8GB Unified", "Storage": "256GB SSD", "Ports": "USB-C (Thunderbolt), USB-A, HDMI", "Weight": "1.29 kg"}' },
